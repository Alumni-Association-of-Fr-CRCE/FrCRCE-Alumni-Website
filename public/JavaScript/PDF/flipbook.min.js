    ...
    (FLIPBOOK.Main = function (e, t) {
      ...
      if (
        ...
        B.on("pageLoaded", function (e) {
          (P.pages[e.index] = P.pages[e.index] || {}),
            ...
            n.Book &&
              n.Book.onPageLoaded &&
              n.Book.onPageLoaded(e.index, e.size),
          ...
          B.on("pdfinit", function () {
            (P.tableOfContent = n.pdfService.outline || P.tableOfContent),
              (P.pageMode = n.pdfService.double
                ? "doubleWithCover"
                : "singlePage"),
      ...
      function y() {
        (n.id = Date.now()),
          n.addPageItems(),
          P.pdfMode
            ? n.initPdf(P.btnSearch.enabled)
            : ((P.btnSearch.enabled = !1), n.initJpg()),
    ...
    (FLIPBOOK.Main.prototype = {
            ...
            if ((n.setLoadingProgress(0.5), 1 == n.options.pages.length)) {
              ...
              n.loadPage(1, n.options.pageTextureSize, function () {
                ...
                (n.options.pw = e.width),
                  ...
                  (n.options.pageHeight = e.height),
                  (n.options.pageMode =
                    1.5 < i / o ? "doubleWithCover" : "singlePage"),
        ...
        if (!this.started) {
          ...
          this.pdfinitStarted ||
            ...
            pdfjsLib.getDocument(o).then(function (e) {
              1 == (t.pdfDocument = e)._pdfInfo.numPages &&
                ((t.options.viewMode = "swipe"),
                (t.options.singlePageMode = !0),
                (t.webgl = !1)),
          ...
          n.img
            ...
            : ((n.img = C.createElement("img")),
              ...
              (n.img.onload = function () {
                (n.imgLoaded = !0),
                  n.htmlContent &&
                    (n.htmlContentDiv = M(C.createElement("div"))
                      .addClass("flipbook-page-htmlContent")
                      .append(M(n.htmlContent))),
                  i.pageLoaded(
                    {
                      index: e,
                      size: t,
      ...
      createBook: function () {
        ...
        if (
          (this.setLoadingProgress(1),
          this.initEasing(),
          "doubleWithCover" == n.options.pageMode && 2 < n.options.pages.length)
        ) {
          for (
          ...
          (this.$findInput = this.$searchBar
            ...
            .keyup(function () {
              ...
              if (
                ...
                i.$findInfo.hide(),
                o.unmark(),
                "" != e && ((o.searchingString = e), o.pdfService))
              )
                for (var t = 0; t < o.pdfService.pdfInfo.numPages; t++)
                  i.findInPage(e, t);
            })),
  ...
  (function (e) {
    ...
    function i(e, f) {
      function t(e) {
        if (
          !(
            ...
            0 < re(e.target).closest(f.excludedElements, Y).length
          )
        ) {
          ...
          if (
            ...
            return (
              ...
              B(),
              O(0, n),
              !i || G === f.fingers || f.fingers === Be || k()
                ? ((ee = E()),
                  2 == G && (O(1, i[1]), (W = V = I(J[0].start, J[1].start))),
                  (f.swipeStatus || f.pinchStatus) && (o = m(t, X)))
                : (o = !1),
              !1 === o
                ? (m(t, (X = Me)), o)
                : (f.hold &&
                    (ae = setTimeout(
                      re.proxy(function () {
                        Y.trigger("hold", [t.target]),
                          f.hold && (o = f.hold.call(Y, t, t.target));
                      }, this),
                      f.longTapThreshold
                    )),
                  T(!0),
      ...
      function o(e) {
        ...
        if (X !== ye && X !== Me && !x()) {
          ...
          if (
            ...
            2 == G &&
              (0 == W
                ? (O(1, p[1]), (W = V = I(J[0].start, J[1].start)))
                : (y(p[1]),
                  (V = I(J[0].end, J[1].end)),
                  J[0].end,
                  J[1].end,
            ...
            if (
              ...
              !f.triggerOnTouchEnd && u
                ? (X = b(Oe))
                : f.triggerOnTouchLeave && !u && (X = b(ye)),
                (X != Me && X != ye) || m(d, X);
            }
          } else m(d, (X = Me));
          !1 === h && m(d, (X = Me));
      ...
      function i(e) {
        ...
        if (i) {
          if (i.length && !x())
            return (t = o), (oe = E()), (ie = t.touches.length + 1), !0;
      ...
      function b(e) {
        ...
        return (
          !o || n
            ? (t = Me)
            : !i || e != Oe || (f.triggerOnTouchEnd && !f.triggerOnTouchLeave)
      ...
      function m(e, t) {
        ...
        return (
          ...
          S() && P() && !1 !== o
            ...
            ? (o = r(e, t, we))
            : !((1 !== G && Le) || !(isNaN(R) || R < f.threshold) || !w()) &&
              !1 !== o &&
              (o = r(e, t, ke)),
          t === Me && n(),
          t === ye && ((i && i.length) || n()),
        ...
        if (o == be) {
          ...
          if (t == ye && c()) {
            if (
              ...
              f.swipe && !1 === (i = f.swipe.call(Y, e, N, R, $, G, J, j)))
            )
              return !1;
            switch (N) {
              case le:
                Y.trigger("swipeLeft", [N, R, $, G, J, j]),
                  f.swipeLeft && (i = f.swipeLeft.call(Y, e, N, R, $, G, J, j));
                break;
              case de:
                Y.trigger("swipeRight", [N, R, $, G, J, j]),
                  f.swipeRight &&
                    (i = f.swipeRight.call(Y, e, N, R, $, G, J, j));
                break;
              case he:
                Y.trigger("swipeUp", [N, R, $, G, J, j]),
                  f.swipeUp && (i = f.swipeUp.call(Y, e, N, R, $, G, J, j));
                break;
              case pe:
                Y.trigger("swipeDown", [N, R, $, G, J, j]),
                  f.swipeDown && (i = f.swipeDown.call(Y, e, N, R, $, G, J, j));
            }
          }
        }
        if (o == me) {
        ...
        return (
          o == ke
                  ...
                  (se = setTimeout(
                    re.proxy(function () {
                      (ne = null),
                        ...
                        f.tap && (i = f.tap.call(Y, e, e.target));
                    }, this),
            ...
            ? (t !== Me && t !== ye) ||
              ...
              f.doubleTap && (i = f.doubleTap.call(Y, e, e.target)))
            : o == we &&
              ((t !== Me && t !== ye) ||
                (clearTimeout(se),
                (ne = null),
                Y.trigger("longtap", [e.target]),
                f.longTap && (i = f.longTap.call(Y, e, e.target)))),
          i
        );
      }
      function l() {
          ...
          (e.prototype.popup = function (e, t) {
            ...
            return (
              ...
              ((i = {
                width: 500,
                height: 350,
              }).top = screen.height / 2 - i.height / 2),
